...
class ChannelPlayListTvFragmentFactory(backgroundManager: BackgroundManager,private val channelHandle:String?,private val channelId:Int?,private val displayName:String):BrowseSupportFragment.FragmentFactory<Fragment>() {
